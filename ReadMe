...
Project Overview
This project presents an innovative approach to sustainable road construction by combining two environmentally friendly concepts. It focuses on both enhancing road performance and promoting the reuse of waste materials in infrastructure projects.

Key Concepts:
Waste Tires in Base Course Layer:
The project incorporates discarded tires in the base course layer of the road, providing a practical solution to the growing problem of tire waste. This not only reduces landfill pressure but also enhances the structural stability of the road base.

Rubber-Bitumen Mixture in Surface Layer:
By blending rubber with bitumen for the road surface, the project improves the road's flexibility and durability. The rubber-bitumen mixture results in a more resistant road surface, effectively minimizing issues such as cracking, rutting, and water damage. Additionally, it reduces the need for frequent maintenance, making it a cost-efficient solution.
...
2. Bituminous Roads (Asphalt Roads):
